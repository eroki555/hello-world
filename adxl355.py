...
class ADXL355:
    ...
    def get_axes(self):
        ...
        #self.write_data(0x28, 0x30)
        #print('0x28= ',self.read_multiple_data(0x51, 0x00))

        # Reading data
        raw_data = self.read_multiple_data(
            [XDATA3, XDATA2, XDATA3, YDATA1, YDATA2, YDATA3, ZDATA1, ZDATA2, ZDATA3]
        )
        ...
        acc_x = float(x_data) * -3.9 / 1000000
        acc_y = float(y_data) * -3.9 / 1000000
        acc_z = float(z_data) * -3.9 / 1000000
